...
const auth_1 = __nccwpck_require__(2926);
...
const pm = __importStar(__nccwpck_require__(3300));
...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(902);
/* harmony import */ var _post__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(9868);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_main__WEBPACK_IMPORTED_MODULE_1__, _post__WEBPACK_IMPORTED_MODULE_2__]);
([_main__WEBPACK_IMPORTED_MODULE_1__, _post__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
/* harmony import */ var tail__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(6773);
...
async function run() {
    ...
    if (username && password) {
        await Promise.all([
            node_fs_promises__WEBPACK_IMPORTED_MODULE_0__.writeFile('up.txt', [username, password].join('\n'), { mode: 0o600 }),
            node_fs_promises__WEBPACK_IMPORTED_MODULE_0__.appendFile(configFile, '\nauth-user-pass up.txt\n'),
        ]);
    }
    ...
    return new Promise((resolve) => {
        ...
        tail.on('line', async (data) => {
            _actions_core__WEBPACK_IMPORTED_MODULE_1__.info(data);
            if (data.includes('Initialization Sequence Completed')) {
                tail.unwatch();
                clearTimeout(timerId);
                const pid = (await node_fs_promises__WEBPACK_IMPORTED_MODULE_0__.readFile(pidFile, 'utf-8')).trim();
                _actions_core__WEBPACK_IMPORTED_MODULE_1__.info(`VPN connection established. PID: ${pid}`);
                resolve(pid);
            }
        });
    });
